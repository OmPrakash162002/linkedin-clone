...
const Profile = () => {
  return (
    <div className=" mt-10 sm:mt-10 md:mt-14 lg:mt-16 py-5 md:py-15 sm:py-5 md:px-10 lg:px-20 xl:px-20 w-full flex flex-col md:flex-row  justify-around gap-4 bg-amber-50 dark:bg-black/95 ">
